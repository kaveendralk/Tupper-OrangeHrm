...
public class Mail_Page {
     ...
     */
    private Mail_Page openGmailAccount(String email, String password) throws MessagingException, InterruptedException, MessagingException {
    ...
    /*
        Read Unseen Message
     */
    public void readUnseenMessage(String email, String password) throws InterruptedException, MessagingException, MessagingException {
    ...
    /*
        Return redeem code
     */
    public  String getCode(String email, String password) throws InterruptedException, MessagingException, MessagingException, IOException {
        openGmailAccount(email,password);
        Message[] messages;
        Thread.sleep(2000);
        //Search for mail from Redeem code subject
    ...
    private String getTextFromMimeMultipart(
            MimeMultipart mimeMultipart) throws MessagingException, IOException, MessagingException {
        String result = "";
